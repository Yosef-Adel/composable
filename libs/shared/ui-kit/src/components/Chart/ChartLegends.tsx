...
// Explicitly typed with return type
export const StyledLegend: StyledComponent<BoxProps> = styled(Box)(({ theme }) => ({
  gap: 6,
  alignItems: 'center',
  display: 'inline-flex',
...
export const StyledDot: StyledComponent<BoxProps> = styled(Box)(() => ({
  width: 12,
  height: 12,
  flexShrink: 0,
  display: 'flex',
